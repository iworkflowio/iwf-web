...
const getLayoutedElements = (nodes: Node[], edges: Edge[], direction = 'TB') => {
  ...
  dagreGraph.setGraph({ 
    rankdir: direction,
    nodesep: 40, // Reduced horizontal spacing between nodes
    ranksep: 40, // Reduced vertical spacing between ranks/levels
  });
        ...
        <div className="w-1/3 overflow-auto border-l border-gray-200">
          <div className="sticky top-0 bg-white border-b border-gray-200 p-3 flex justify-between items-center">
            ...
            <button 
              ...
              className="bg-gray-200 hover:bg-gray-300 text-gray-700 p-1.5 rounded-full flex items-center justify-center"
